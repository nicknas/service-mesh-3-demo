...
* Stack de **observabilidad**: Kiali, OpenTelemetry Collector, MinIO, Tempo, Loki (OpenShift Logging) y Grafana
...
| 5d | `openshift-logging-operator` | `05-openshift-logging-operator.yaml`
...
for ns in bookinfo istio-ingress istio-system istio-cni tracing-system openshift-logging grafana-system \
