...
|===
| Operador (OLM) | Chart Helm | Argo CD Application | Namespace OLM | Catálogo | CSV / canal

| **OpenShift GitOps**
| `helm-charts/openshift-gitops-operator`
| _(bootstrap manual)_
| `openshift-gitops-operator`
| `redhat-operators`
| `openshift-gitops-operator.v1.21.3` — canal `latest`

| **OpenShift Service Mesh 3** (`servicemeshoperator3`)
| `helm-charts/sm3-operator`
| `service-mesh3-operator`
| `openshift-operators`
| `redhat-operators`
| `servicemeshoperator3.v3.1.6` — canal `stable`

| **Kiali Operator**
| `helm-charts/kiali-operator`
| `kiali-operator`
| `openshift-operators`
| `redhat-operators`
...
| `helm-charts/cluster-observability-operator`
| `cluster-observability-operator`
