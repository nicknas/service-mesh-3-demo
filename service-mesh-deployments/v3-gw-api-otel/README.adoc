...
Desplegamos el manifest *__06-control-plane.yaml__* de ArgoCD. Esto creará los objetos *Istio* (en el namespace istio-system) e *IstioCNI* (en el namespace istio-cni). Además se creará automáticamente el objeto *IstioRevision* (en el namespace istio-system)

=== Desplegar la aplicación 'bookinfo'
Desplegamos el manifest *__07-bookinginfo-application.yaml__* que:
...
Creamos el gateway para la aplicación *bookinfo* aplicando el manifest *__09-bookinfo-gateway.yaml__*
